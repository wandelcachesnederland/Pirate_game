...
export const ERA_SCENES: Record<EraId, EraSceneSpec> = {
  ...
  phoenicia: {
    ribbon: 'Tyre',
    sky: ['#1e6d9e', '#79bade', '#f4ecd4'],
    glow: [0.7, 0.03, 0.55, '#fff6d8', 0.45],
    coast: [['hills', 0.16, 1.1], ['temple', 0.44, 0.95], ['city', 0.72, 0.85], ['hills', 0.92, 0.9]],
    weather: 'haze',
    swell: 0.4,
    glitter: 0.45,
    emblem: 'trident',
    accent: ['#8e1c14', '#e8c14a'],
    cast: [
      ['hero', 0.3, 0.74, 0.4, -0.2],
      ['tyrianKing', 0.7, 0.52, 0.46, 0.14, { hp: 0.55 }],
      ['pentekonter', 0.9, 0.3, 0.18, -0.2],
    ],
    fx: [['ram', 0, 1], ['arrows', 0, 1, 2.0]],
  },
  hanse: {
    ribbon: 'The Sound',
    sky: ['#4b585c', '#8b9592', '#cdc6ae'],
    glow: [0.4, 0.05, 0.6, '#ece2c6', 0.25],
    coast: [['hills', 0.16, 1], ['city', 0.46, 0.9], ['forest', 0.74, 1], ['hills', 0.92, 0.85]],
    weather: 'fog',
    swell: 0.5,
    glitter: 0.12,
    emblem: 'anchor',
    accent: ['#8e1c14', '#e2c46a'],
    cast: [
      ['hero', 0.28, 0.72, 0.4, -0.12],
      ['hansakogge', 0.7, 0.52, 0.46, 0.12, { hp: 0.6 }],
      ['cog', 0.9, 0.3, 0.18, -0.15],
    ],
    fx: [['arrows', 0, 1, 2.2], ['arrows', 1, 0, 2.8]],
  },
  portugal: {
    ribbon: 'Calicut',
    sky: ['#1f74b6', '#79bade', '#f4ecd4'],
    glow: [0.72, 0.03, 0.55, '#fff6d8', 0.5],
    coast: [['palms', 0.18, 1], ['village', 0.46, 0.85], ['palms', 0.74, 0.9], ['hills', 0.92, 0.8]],
    weather: 'haze',
    swell: 0.4,
    glitter: 0.5,
    emblem: 'compass',
    accent: ['#1f5f8f', '#2e8a4a'],
    cast: [
      ['hero', 0.3, 0.72, 0.4, -0.18],
      ['nauCapitana', 0.7, 0.5, 0.46, 0.14],
      ['fusta', 0.9, 0.3, 0.18, -0.2],
    ],
    fx: [['broadside', 0, 1, 3.0], ['broadside', 1, 0, 3.8]],
  },
  armada: {
    ribbon: 'Gravelines',
    sky: ['#2b3a4c', '#5c6d7c', '#b6bcb6'],
    glow: [0.22, 0.05, 0.6, '#e2dcc0', 0.22],
    coast: [['cliffs', 0.16, 1.1], ['sails', 0.46, 1], ['fleet', 0.72, 0.9], ['cliffs', 0.92, 0.8]],
    weather: 'storm',
    swell: 0.9,
    glitter: 0.06,
    emblem: 'crown',
    ...
    props: ['shoreFire'],
    cast: [
      ['hero', 0.26, 0.74, 0.38, -0.12],
      ['armadaCapitana', 0.68, 0.54, 0.48, 0.16, { hp: 0.5, burn: 0.4 }],
      ['galleass', 0.9, 0.32, 0.2, -0.15],
    ],
    fx: [['broadside', 0, 1, 2.2], ['broadside', 1, 0, 2.9]],
  },
  dutch: {
    ribbon: 'The Texel',
    sky: ['#3a5a78', '#7aa0b4', '#d8e4e0'],
    glow: [0.55, 0.04, 0.55, '#fff3c4', 0.35],
    coast: [['hills', 0.14, 0.9], ['city', 0.42, 0.85], ['sails', 0.7, 1], ['hills', 0.92, 0.8]],
    weather: 'clear',
    swell: 0.55,
    glitter: 0.35,
    emblem: 'star',
    accent: ['#e07a28', '#1f3b63'],
    cast: [
      ['hero', 0.28, 0.72, 0.4, -0.14],
      ['spiegelretour', 0.7, 0.52, 0.46, 0.12, { hp: 0.55 }],
      ['jacht', 0.9, 0.3, 0.16, -0.2],
    ],
    fx: [['broadside', 0, 1, 2.5], ['broadside', 1, 0, 3.2]],
  },
  ottoman: {
    ribbon: 'Preveza',
    sky: ['#2b6a9e', '#7ab4d4', '#f0e4c4'],
    glow: [0.65, 0.04, 0.55, '#ffe6b0', 0.4],
    coast: [['hills', 0.16, 1.1], ['castle', 0.44, 0.95], ['mosque', 0.7, 0.85], ['hills', 0.92, 0.9]],
    weather: 'haze',
    swell: 0.4,
    glitter: 0.4,
    emblem: 'crescent',
    accent: ['#8e1c14', '#e8c766'],
    cast: [
      ['hero', 0.3, 0.74, 0.4, -0.18],
      ['laReal', 0.7, 0.52, 0.44, 0.14, { hp: 0.55 }],
      ['venetianGalley', 0.9, 0.32, 0.2, -0.12],
    ],
    fx: [['broadside', 0, 1, 2.4], ['ram', 0, 1]],
  },
  predread: {
    ribbon: 'Tsushima',
    sky: ['#2c3e52', '#5d7488', '#a7b4ba'],
    glow: [0.24, 0.05, 0.7, '#e4eaec', 0.22],
    coast: [['fleet', 0.16, 1], ['fleet', 0.46, 0.9], ['hills', 0.76, 1], ['hills', 0.94, 0.8]],
    weather: 'fog',
    swell: 0.5,
    glitter: 0.1,
    emblem: 'chrysanthemum',
    accent: ['#8a2a26', '#e0b85c'],
    props: ['wreck'],
    cast: [
      ['hero', 0.28, 0.72, 0.42, -0.1],
      ['borodino', 0.7, 0.52, 0.48, 0.14, { hp: 0.4, burn: 0.5 }],
      ['tb1890', 0.9, 0.3, 0.16, -0.1],
    ],
    fx: [['broadside', 0, 1, 2.6], ['shells', 1, 0, 3.4]],
  },
  falklands: {
    ribbon: 'Falkland Sound',
    sky: ['#3a4a58', '#6a7a88', '#c4c8c0'],
    glow: [0.3, 0.05, 0.65, '#e4eaec', 0.2],
    coast: [['cliffs', 0.16, 1.2], ['hills', 0.48, 1], ['cliffs', 0.78, 1.1], ['hills', 0.94, 0.85]],
    weather: 'storm',
    swell: 0.85,
    glitter: 0.08,
    emblem: 'missile',
    accent: ['#1f3b63', '#c0392b'],
    props: ['oilSlick'],
    cast: [
      ['hero', 0.3, 0.72, 0.4, -0.12],
      ['belgrano', 0.7, 0.52, 0.48, 0.16, { hp: 0.45, burn: 0.35 }],
      ['argCorvette', 0.9, 0.3, 0.18, -0.1],
    ],
