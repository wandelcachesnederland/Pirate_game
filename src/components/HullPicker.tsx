...
import { ERA_SHIPS } from '../game/ships/era';
...
/** Choose your flagship: five era hulls, one per period. */
        ...
        {ERA_SHIPS.map((e) => {
          ...
          return (
            ...
            >
              ...
              {on && <div className="mt-1 text-[0.68rem] italic leading-tight opacity-80">{e.blurb}</div>}
            </button>
          );
        })}
      </div>
