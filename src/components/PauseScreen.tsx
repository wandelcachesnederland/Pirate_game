    ...
    <div className="anim-fade absolute inset-0 overflow-y-auto bg-[#03101f]/60 backdrop-blur-[2px]">
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="parchment anim-pop w-full max-w-sm p-6 text-center">
          ...
          <h2 className="font-pirate text-5xl leading-tight">{t('pause.title')}</h2>
          <p className="italic opacity-80">{t('pause.subtitle')}</p>
          <div className="mt-5 flex flex-col gap-3">
            ...
            >
              <Play className="h-6 w-6" /> {t('pause.resume')}
            ...
            >
              <RotateCcw className="h-5 w-5" /> {t('pause.restart')}
